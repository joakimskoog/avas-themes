...
const tokyoNightPalette: TokyoNightPalette = {
  background: "rgb(26, 27, 38)",
  backgroundSubtle: "rgb(22, 22, 30)",
  backgroundLowest: "rgb(16, 16, 20)",
  elevated: "rgb(22, 22, 30)",
  elevatedHover: "rgb(32, 35, 48)",
  border: "rgb(84, 92, 126)",
  borderSubtle: "rgb(41, 46, 66)",
  selected: "rgb(81, 92, 126)",
  shadow: "rgb(0, 0, 0)",
  text: "rgb(192, 202, 245)",
  textDiscreet: "rgb(169, 177, 214)",
  textDisabled: "rgb(84, 92, 126)",
  onAccent: "rgb(26, 27, 38)",
...
const tokyoNightTheme = compileTokyoNightTheme("tokyo-night", "Tokyo Night", tokyoNightPalette);
